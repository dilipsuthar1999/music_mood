...
<html lang="en">
  ...
  <title>Music Mood | Sign up</title>
  </head>
  <body>
  			...
  			<div class="col-md-8 col-sm-10 col-10">
  				<div class="row box">
		  			...
		  			<div class="col-md-5">
					  	...
					  	<form class="form" id="signup_form" autocomplete="off">
					  		...
					  		<div class="input-group mb-3">
							  	...
							  	<input type="password" name="cpassword" class="form-control" placeholder="Confirm Password" aria-label="Password" aria-describedby="basic-addon2">
							</div>
							<button type="submit" name="submit" id="sign_up" class="btn btn-primary">Sign up</button>
					  	</form>
					  	<a href="<?= base_url().'account'; ?>" class="foot">have an account?</a>
					</div>
  					<div class="col-md-1"></div>
				</div>
			</div>
